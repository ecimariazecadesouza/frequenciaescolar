        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
          <table className="min-w-full divide-y divide-gray-200 text-sm">
            <thead className="bg-slate-50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Nome do Protagonista</th>
                <th className="px-6 py-3 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Turma</th>
                <th className="px-6 py-3 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Situação</th>
              ...
              {filteredStudents.length === 0 ? (
                  <tr>
                      <td colSpan={4} className="px-6 py-12 text-center text-slate-400">
                          Nenhum protagonista encontrado com os filtros atuais.
                      </td>
                  </tr>
              ) : (
                  filteredStudents.map(student => {
                    ...
                    return (
                        ...
                        <td className="px-6 py-4 whitespace-nowrap font-medium text-slate-800">{student.name}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-slate-600">
                            {studentClass ? (
                                ...
                                <span className="text-slate-400 italic">Sem turma</span>
                            )}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded border ${ENROLLMENT_COLORS[student.status]}`}>
                                {student.status}
                            </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            ...
                            <button 
                                ...
                                className="text-rose-600 hover:text-rose-900 p-2 hover:bg-rose-50 rounded-full transition-colors ml-1"
                                title="Remover"
                            >
                                <Trash2 size={16} />
                            </button>
